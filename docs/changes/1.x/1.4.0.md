...
### Note
- Writer ODText previously used to set 'style:use-window-font-color' to 'true'.
  The effect of this attribute is "implementation dependent" (if implemented at all).
  Not setting it allows setting a default font color and improves interoperabilt,
